...
class ChangePasswordDialog extends StatefulWidget {
  ...
  const ChangePasswordDialog({super.key, required this.authProvider});

  static Future<void> show(BuildContext context, AuthProvider authProvider) async {
    await showDialog(
      context: context,
      builder: (_) => ChangePasswordDialog(authProvider: authProvider),
    );
  }
...
class _ChangePasswordDialogState extends State<ChangePasswordDialog> {
  ...
  Future<void> _save() async {
    ...
    String? errorMsg;
    try {
      await widget.authProvider.changeOwnPassword(
        oldPassword: oldP,
        newPassword: newP,
      );
      ok = true;
